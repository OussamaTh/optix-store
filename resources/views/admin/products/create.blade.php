        ...
        <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input id="name" type="text" name="name" value="{{ old('name') }}" required
                    placeholder="e.g. Ember Round Sunglasses"
            ...
            <div>
                <label for="price" class="block text-sm font-medium text-[#1b1b18] mb-2">Price (USD)</label>
                <div class="relative">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select id="category" name="category" required
                        ...
                        <option value="glasses" {{ old('category') === 'glasses' ? 'selected' : '' }}>Glasses</option>
                        <option value="sunglasses" {{ old('category') === 'sunglasses' ? 'selected' : '' }}>Sunglasses
                        </option>
                    </select>
                    @error('category')
                        <p class="mt-1.5 text-xs text-red-500">{{ $message }}</p>
            ...
            <div>
                ...
                <label for="image"
                    ...
                    <img id="preview-img" class="hidden mx-auto max-h-48 object-contain rounded-xl" alt="Preview">
                </label>
